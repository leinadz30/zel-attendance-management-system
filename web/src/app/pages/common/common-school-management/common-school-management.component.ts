...
import { CommonSchoolsTableColumn } from 'src/app/shared/utility/table';

@Component({
  selector: 'app-common-school-management',
  templateUrl: './common-school-management.component.html',
  styleUrls: ['./common-school-management.component.scss'],
  host: {
    class: "page-component"
  }
})
export class CommonSchoolManagementComponent {
        ...
        if(res.success){
          let data = res.data.results.map((d)=>{
            return {
              ...
              url: `${this.mode === "OPERATION" ? '/ops' : '/org'}/school-management/${d.schoolCode}`,
            } as CommonSchoolsTableColumn
          });
