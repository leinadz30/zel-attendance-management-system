...
@Component({
  selector: 'app-common-sections-form',
  templateUrl: './common-sections-form.component.html',
  styleUrls: ['./common-sections-form.component.scss']
})
export class CommonSectionFormComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CommonSectionFormComponent>) {
