...
@Component({
  selector: 'app-common-strands-form',
  templateUrl: './common-strands-form.component.html',
  styleUrls: ['./common-strands-form.component.scss']
})
export class CommonStrandFormComponent {
  strandCode;
  isNew = false;
  error;
  isLoading = true;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CommonStrandFormComponent>) {
