...
@Component({
  selector: 'app-common-students-form',
  templateUrl: './common-students-form.component.html',
  styleUrls: ['./common-students-form.component.scss']
})
export class CommonStudentFormComponent {
  title;
  studentCode;
  isNew = false;
  viewOnly = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CommonStudentFormComponent>) {
