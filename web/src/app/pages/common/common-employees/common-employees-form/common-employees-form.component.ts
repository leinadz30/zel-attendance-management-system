...
@Component({
  selector: 'app-common-employees-form',
  templateUrl: './common-employees-form.component.html',
  styleUrls: ['./common-employees-form.component.scss']
})
export class CommonEmployeeFormComponent {
  employeeCode;
  isNew = false;
  error;
  isLoading = true;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CommonEmployeeFormComponent>) {
    ...
    try {
      forkJoin([
        ...
        if (employee.success) {
          ...
          this.department = employee.data?.department;
