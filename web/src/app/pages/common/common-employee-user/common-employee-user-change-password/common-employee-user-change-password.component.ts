...
@Component({
  selector: 'app-common-employee-user-change-password',
  templateUrl: './common-employee-user-change-password.component.html',
  styleUrls: ['./common-employee-user-change-password.component.scss']
})
export class ComminEmployeeUserChangePasswordComponent {
  isProcessing = false;
  error;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ComminEmployeeUserChangePasswordComponent>) {
  ...
  onSubmitChangePassword() {
    ...
    dialogRef.componentInstance.conFirm.subscribe(async (data: any) => {
      ...
      try {
        ...
        this.isProcessing = true;
        const res = await this.employeeUserService.updatePassword(this.employeeCode, params).toPromise();
