...
@Component({
  selector: 'app-common-departments-form',
  templateUrl: './common-departments-form.component.html',
  styleUrls: ['./common-departments-form.component.scss']
})
export class CommonDepartmentFormComponent {
  departmentCode;
  isNew = false;
  error;
  isLoading = true;
