...
@Component({
  selector: 'app-ops-machines-form',
  templateUrl: './ops-machines-form.component.html',
  styleUrls: ['./ops-machines-form.component.scss']
})
export class OpsMachineFormComponent {
  machineCode;
  isNew = false;
  error;
  isLoading = true;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OpsMachineFormComponent>) {
