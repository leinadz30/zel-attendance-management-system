...
import { OpsCoursesTableColumn } from 'src/app/shared/utility/table';
...
@Component({
  selector: 'app-ops-courses',
  templateUrl: './ops-courses.component.html',
  styleUrls: ['./ops-courses.component.scss'],
  host: {
    class: "page-component"
  }
})
export class OpsCoursesComponent {
  currentOperatorCode:string;
  error:string;
  dataSource = new MatTableDataSource<OpsCoursesTableColumn>();
  columnDefs = [];
  displayedColumns = [];
  isLoading = false;
  isProcessing = false;
  ...
  controlMenuItemSelected(type: "edit" | "delete", data: OpsCoursesTableColumn) {
    console.log(type, data);
    if(type === "edit") {
      const dialogRef = this.dialog.open(OpsCourseFormComponent, {
        maxWidth: '720px',
        width: '720px',
        disableClose: true,
